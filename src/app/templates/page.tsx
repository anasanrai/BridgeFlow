              ...
              <div className="grid grid-cols-1 gap-12">
                {filteredTemplates.length > 0 ? (
                  ...
                  <div className="text-center py-20 glass rounded-3xl border border-dashed border-white/10">
                    ...
                    <p className="text-gray-500 mb-4">Try adjusting your search or category filters, or browse all templates.</p>
                    <button
                      onClick={() => { setActiveCategory("all"); setSearchQuery(""); }}
                      className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-semibold text-gold-400 border border-gold-400/20 rounded-full hover:bg-gold-400/5 transition-colors"
                    >
                      Clear Filters
                    </button>
                  </div>
