...
export default function LayoutShell({
    ...
    return (
        <>
            ...
            <a
                href="#main-content"
                className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[9999] focus:px-4 focus:py-2 focus:text-sm focus:font-semibold focus:text-neutral-950 focus:bg-brand-coral text-neutral-950 font-bold focus:rounded-lg focus:shadow-lg"
            >
