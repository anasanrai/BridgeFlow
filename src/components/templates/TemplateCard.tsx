...
import { ArrowRight, Clock, Zap, DollarSign } from "lucide-react";
...
export default function TemplateCard({ template, compact = false }: TemplateCardProps) {
    ...
    return (
        <div
            className="template-card group relative flex flex-col rounded-2xl overflow-hidden border border-white/8 hover:border-white/20 transition-all duration-300 hover:-translate-y-1"
            style={{
        ...
        >
            ...
            <div className="flex flex-col flex-1 p-5 gap-3">
                ...
                <div className="flex gap-2 pt-1">
                    ...
                    <Link
                        href={`/templates/${template.slug}#get`}
                        className="flex-1 flex items-center justify-center gap-1.5 py-2 rounded-xl text-[11px] font-bold uppercase tracking-wider text-navy-950 transition-all hover:shadow-[0_0_20px_rgba(230,180,34,0.3)]"
